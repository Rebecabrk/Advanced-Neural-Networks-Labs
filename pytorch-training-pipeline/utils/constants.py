...
with open(
    "/Users/rebecacostache/Desktop/Advanced-Neural-Networks-Labs/pytorch-training-pipeline/configs/optimizers.yaml", 
    "r") as f:
    OPTIMIZER_PARAMS = yaml.safe_load(f)

with open(
    "/Users/rebecacostache/Desktop/Advanced-Neural-Networks-Labs/pytorch-training-pipeline/configs/transforms.yaml",
      "r") as f:
    TRANSFORM_PRESETS = yaml.safe_load(f)

with open(
    "/Users/rebecacostache/Desktop/Advanced-Neural-Networks-Labs/pytorch-training-pipeline/configs/MLP.yaml",
      "r") as f:
    MLP_PARAMS = yaml.safe_load(f)
    
with open(
    "/Users/rebecacostache/Desktop/Advanced-Neural-Networks-Labs/pytorch-training-pipeline/configs/schedulers.yaml",
      "r") as f:
